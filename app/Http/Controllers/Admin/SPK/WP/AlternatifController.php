...
class AlternatifController extends Controller
{
    ...
    public function index(Request $request, WP $spk)
    {
        ...
        $view = path_view('pages.admin.spk.wp.alternatif');
    ...
    public function datatable(WP $spk)
    {
        return AlternatifNilai::datatable($spk);
    }

    public function kriteria(WP $spk)
    {
        try {
