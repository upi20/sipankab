...
class Client extends Model
{
    ...
    const image_folder = '/assets/client';
    const image_default = 'assets/client/default.jpg';
    const feClientLayananCacheKey = 'feClientLayanan';
    ...
    public static function getFeClientLayananData()
    {
        return Cache::rememberForever(static::feClientLayananCacheKey, function () {
            return static::where('status', 1)->orderBy('nama', 'desc')->get();
        });
    }
    ...
    {
        $cacheKey = [
            static::feClientLayananCacheKey,
        ];
